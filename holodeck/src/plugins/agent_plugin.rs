...
use crate::systems::{
    agents, animation, blocking, capabilities, disconnect_visual, layout, particles, selection,
    snapshots, spine, step_complete, task_ring, thoughts,
};
...
impl Plugin for AgentPlugin {
    fn build(&self, app: &mut App) {
        app
            ...
            .add_systems(
                Update,
                (spine::attach_spine_to_agents, spine::update_spine_system),
            )
            // Task progress ring
            .add_systems(
                Update,
            ...
            .add_systems(
                Update,
                asset_animator_system::<AgentShellMaterial, MeshMaterial3d<AgentShellMaterial>>,
            );
    }
}
